        ...
        >
          ...
          <div className="w-[285px] flex flex-col items-start">
            <div className="flex flex-row items-center p-0 gap-[8px] h-[30px]">
              <Image
                src="/backpack/gift_props/gift_props.svg"
                alt="Gift Props"
                width={16}
                height={16}
              />
              <h2
                id="gift-props-title"
                className="text-white text-[16px] font-medium leading-[22px]"
              >
                Gift Props
              </h2>
            </div>
          ...
          <div className="w-[285px] flex flex-col gap-[10px]">
            ...
            <div className="flex flex-col gap-[4px] w-[285px] h-[68px]">
              ...
              <div className="ui-input ui-input--dark flex flex-row items-center w-[285px] h-[42px] rounded-[12px] px-[10px]">
                <span
                  aria-hidden
                  className="mx-2 w-px h-4"
                  style={{ background: 'rgba(228,228,228,0.6)' }}
                />
                <input
                  id="gift-username"
                  name="username"
